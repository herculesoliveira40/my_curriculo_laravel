    ...
    <div
        ...
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mt-8 bg-white dark:bg-gray-800 overflow-hidden shadow sm:rounded-lg">
                <p> Projeto My Curriculo desenvolvido por Hercules Oliveira, colocando em pratica conhecimentos
                    apreendidos,
                    Utilizando Framework Laravel PHP, Template engine Blade, Javascript, MySQL, Bootstrap, jQuery,
                    biblioteca DomPDF.
