...
@section('content')
    <h1> Usuarios <a href="{{ route('users.create') }}"> +</a></h1>
                    ...
                    <tbody>
                        @foreach($users as $user)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('users.edit', $user->id) }}" class="btn btn-warning edit-btn">
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <button type="submit" class="btn btn-danger delete-btn"> <i class="bi bi-trash3-fill">
                                                        </i> Delete 
                                                        </button>
                                                    </div>
                                                </div>
